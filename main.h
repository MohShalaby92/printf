 ...
 * @splace_flag: on if hashtag_flag specified
...
int print_number_right_shift(cahr *str, params_t *params);
int print_number_left_shift(char *str, parmas_t *params);
